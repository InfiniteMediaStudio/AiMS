...
values (
  ...
  "meta": {
    ...
    "currentState": "The roadmap is now hosted in Supabase and served by Vercel. The active phase is Online Manager API, with a protected, version-checked roadmap endpoint being added before voice control.",
    "nextFocus": "Configure the server-only Supabase variables and admin allowlist in Vercel, verify the authenticated roadmap API, then add the owner sign-in flow."
  },
  "stats": [
    {
      "label": "Overall",
  ...
  "agents": [
    ...
    },
    {
      ...
      "progress": 36,
      "status": "in process",
      "statusAction": "Cloud storage is online; the active work is the authenticated Manager API boundary.",
      "priority": "P0",
      "nextFocus": false
    },
    {
  ...
  "phases": [
    ...
    },
    {
      ...
      "mode": "build",
      "progress": 100,
      "summary": "Supabase is connected to GitHub, secured schema migrations apply successfully, and the production frontend loads the hosted aims-roadmap document with a bundled fallback.",
      "todo": "Keep future schema and seed changes versioned through GitHub migrations.",
      "statusAction": "Hosted roadmap data is complete for the current cloud foundation."
    },
    {
      "number": "08",
      ...
      "mode": "build",
      "progress": 38,
      "summary": "A protected Vercel Function now verifies Supabase users, enforces an admin email allowlist, and performs version-checked roadmap updates through a restricted database function.",
      "todo": "Configure server-only Vercel variables, verify the endpoint in production, and add the owner sign-in flow.",
      "statusAction": "Active next focus: configure and verify the authenticated online roadmap API.",
      "nextFocus": true
    },
    {
      "number": "09",
  ...
  "stack": [
    ...
    },
    {
      ...
      "status": "active",
      "progress": 90,
      "next": "Hosted reads are active; finish authenticated API writes and owner sign-in."
    },
    {
  ...
  "workRound": {
    ...
    "lastCompleted": "Completed hosted roadmap storage, moved next-focus tracking into Roadmap Phases, added section completion totals, and implemented the protected version-checked roadmap API boundary."
  },
  "managerControlPlane": {
    "taskLifecycle": [
      "intake",
